...
const ThreadPanel = ({
	...
	const parentSender =
		parentMessage?.senderName || parentMessage?.sender?.username || "Pengguna";

	return (
		<div className='flex flex-col h-full w-80 border-l border-slate-200 bg-slate-50 max-lg:fixed max-lg:inset-0 max-lg:z-[60] max-lg:w-full max-lg:border-l-0 max-lg:shadow-2xl'>
			{/* Header */}
			<div className='flex items-center justify-between px-4 py-3 border-b border-slate-200 bg-white pt-[max(0.75rem,env(safe-area-inset-top))]'>
