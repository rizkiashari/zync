...
const variantMap = {
	...
	"ghost-dark":
		"bg-transparent hover:bg-slate-700 text-slate-300 disabled:opacity-50",
	outline:
		"border border-slate-300 hover:bg-slate-50 text-slate-700 disabled:opacity-50",
};

const sizeMap = {
	sm: "px-3 py-2 text-sm rounded-lg min-h-11",
	md: "px-4 py-2 text-sm rounded-lg min-h-11",
	lg: "px-6 py-2.5 text-base rounded-xl min-h-12",
};
