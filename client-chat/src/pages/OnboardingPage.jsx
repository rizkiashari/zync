...
const OnboardingPage = () => {
	...
	return (
		...
		>
			...
			<main
				className={`w-full z-10 relative ${native ? "max-w-lg mx-auto" : maxWidthClass}`}
								...
								>
									<div>
										...
										<div className='relative'>
											<Building2
												className={`absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 ${native ? "text-zinc-500" : "text-slate-400"}`}
											/>
											<input
												type='text'
									...
									<div>
										...
										>
											...
											<span
												className={
													native ? "text-zinc-600 font-normal" : (
